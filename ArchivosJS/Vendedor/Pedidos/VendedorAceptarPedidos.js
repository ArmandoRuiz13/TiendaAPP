...
export default class Bajas extends Component {
    ...
    render() {
        const { navigate} = this.props.navigation;
          ...
          const MensajeError = () => {
            alert("Necesitas elegir un repartidor");
          }
        let _this = this
        const btnClick = () => {
            if(this.state.repartidor == "Pendiente"){
                MensajeError();
            }else{
        ...
        return (
            <View>
                ...
                <View style ={{margin:10,borderWidth:1,borderBottomColor:"black",marginBottom:10}}>
                    <Text >Selecciona un repartidor:</Text>
                ...
                <View style={styles.boton}>
                <Button title = 'Aceptar Pedido' onPress={btnClick}></Button>
                </View>
                <View style={styles.boton}>
